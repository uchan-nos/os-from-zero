...
未検証ですが、Intel Mac なら開発できるでしょう。ただ、標準の開発環境（mikanos-build）は今のところ Mac に対応していませんから、自力で環境を整える必要があります。

M1 Mac では難しいかもしれません。MikanOS は x86-64 向けですが、M1 Mac は ARM だからです。M1 Mac 上で x86-64 向けのプログラムを開発するノウハウが、そのうち Web 上にたまってくるかもしれません。
